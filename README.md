...
Backend developer and automator in Web3.  
I build bots, automations and backend infrastructure.
...
• Backend services with **Node.js, Express, NestJS, Java, Spring**  
• Automations and bots for **Web3 projects and CRM systems**  
• API integrations, databases, and cloud tools  
• Crypto wallet scripts, testnet workflows, and on-chain data  
